...
class AdminFarmMyFarmEditCompany extends ConsumerStatefulWidget {
  final AppUserModel appUser;
  const AdminFarmMyFarmEditCompany({super.key, required this.appUser});

  @override
  AdminFarmMyFarmEditCompanyState createState() =>
      AdminFarmMyFarmEditCompanyState();
}

class AdminFarmMyFarmEditCompanyState
    extends ConsumerState<AdminFarmMyFarmEditCompany> {
