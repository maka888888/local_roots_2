...
class AdminFarmMyFarmEditCategories extends ConsumerStatefulWidget {
  final AppUserModel appUser;
  const AdminFarmMyFarmEditCategories({super.key, required this.appUser});

  @override
  AdminFarmMyFarmEditCategoriesState createState() =>
      AdminFarmMyFarmEditCategoriesState();
}

class AdminFarmMyFarmEditCategoriesState
    extends ConsumerState<AdminFarmMyFarmEditCategories> {
