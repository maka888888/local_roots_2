...
class AdminFarmMyFarmEditMainPhoto extends ConsumerStatefulWidget {
  final AppUserModel appUser;
  const AdminFarmMyFarmEditMainPhoto({super.key, required this.appUser});

  @override
  AdminFarmMyFarmEditMainPhotoState createState() =>
      AdminFarmMyFarmEditMainPhotoState();
}

class AdminFarmMyFarmEditMainPhotoState
    extends ConsumerState<AdminFarmMyFarmEditMainPhoto> {
