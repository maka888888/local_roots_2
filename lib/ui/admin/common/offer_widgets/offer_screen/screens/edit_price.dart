...
class AdminOfferEditPrice extends ConsumerStatefulWidget {
  final OfferModel offer;
  const AdminOfferEditPrice({super.key, required this.offer});

  @override
  AdminOfferEditPriceState createState() => AdminOfferEditPriceState();
}

class AdminOfferEditPriceState extends ConsumerState<AdminOfferEditPrice> {
