...
class AdminOfferEditUnit extends ConsumerStatefulWidget {
  final OfferModel offer;
  const AdminOfferEditUnit({super.key, required this.offer});

  @override
  AdminOfferEditUnitState createState() => AdminOfferEditUnitState();
}

class AdminOfferEditUnitState extends ConsumerState<AdminOfferEditUnit> {
