...
class FarmerOnboardingStepCertificates extends ConsumerStatefulWidget {
  final double progress;
  const FarmerOnboardingStepCertificates({super.key, required this.progress});

  @override
  FarmerOnboardingStepCertificatesState createState() =>
      FarmerOnboardingStepCertificatesState();
}

class FarmerOnboardingStepCertificatesState
    extends ConsumerState<FarmerOnboardingStepCertificates> {
