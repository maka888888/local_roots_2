...
class FarmerFarmMyFarmEditPhotos extends ConsumerStatefulWidget {
  final AppUserModel appUser;
  const FarmerFarmMyFarmEditPhotos({super.key, required this.appUser});

  @override
  FarmerFarmMyFarmEditPhotosState createState() =>
      FarmerFarmMyFarmEditPhotosState();
}

class FarmerFarmMyFarmEditPhotosState
    extends ConsumerState<FarmerFarmMyFarmEditPhotos> {
