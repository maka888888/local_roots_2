...
class FarmerFarmMyFarmEditName extends ConsumerStatefulWidget {
  final AppUserModel appUser;
  const FarmerFarmMyFarmEditName({super.key, required this.appUser});

  @override
  FarmerFarmMyFarmEditNameState createState() =>
      FarmerFarmMyFarmEditNameState();
}

class FarmerFarmMyFarmEditNameState
    extends ConsumerState<FarmerFarmMyFarmEditName> {
