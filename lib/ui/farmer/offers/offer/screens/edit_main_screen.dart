...
class FarmerOfferEditMainPhoto extends ConsumerStatefulWidget {
  final OfferModel offer;
  const FarmerOfferEditMainPhoto({super.key, required this.offer});

  @override
  FarmerOfferEditMainPhotoState createState() =>
      FarmerOfferEditMainPhotoState();
}

class FarmerOfferEditMainPhotoState
    extends ConsumerState<FarmerOfferEditMainPhoto> {
