...
class FarmerOfferEditName extends ConsumerStatefulWidget {
  final OfferModel offer;
  const FarmerOfferEditName({super.key, required this.offer});

  @override
  FarmerOfferEditNameState createState() => FarmerOfferEditNameState();
}

class FarmerOfferEditNameState extends ConsumerState<FarmerOfferEditName> {
