...
class FarmerSalesLocationStepHours extends ConsumerStatefulWidget {
  final double progress;
  const FarmerSalesLocationStepHours({super.key, required this.progress});

  @override
  FarmerSalesLocationStepHoursState createState() =>
      FarmerSalesLocationStepHoursState();
}

class FarmerSalesLocationStepHoursState
    extends ConsumerState<FarmerSalesLocationStepHours> {
  ...
  _back() {
    setState(() {
      _salesLocation.onboardingStep = SalesLocationNewStep.name;
    });
    ref
