...
class CustomerOnboardingStepPhoto extends ConsumerStatefulWidget {
  final double progress;
  const CustomerOnboardingStepPhoto({super.key, required this.progress});

  @override
  CustomerOnboardingStepPhotoState createState() =>
      CustomerOnboardingStepPhotoState();
}

class CustomerOnboardingStepPhotoState
    extends ConsumerState<CustomerOnboardingStepPhoto> {
